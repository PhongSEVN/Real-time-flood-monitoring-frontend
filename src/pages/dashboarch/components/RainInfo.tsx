...
const CurrentView = () => (
  <div className="space-y-6">
    ...
    <div className="h-[300px] w-full">
      <h4 className="text-slate-600 font-semibold mb-4">Biểu đồ lượng mưa theo giờ (Thực đo)</h4>
      <ResponsiveContainer width="100%" height="100%">
        <AreaChart data={currentData}>
          ...
          <YAxis />
          <Tooltip />
          <Area type="monotone" dataKey="mm" stroke="#3b82f6" fillOpacity={1} fill="url(#colorMm)" name="Lượng mưa (mm)" />
        </AreaChart>
      </ResponsiveContainer>
    </div>
  </div>
...
const ForecastView = () => (
  <div className="space-y-4">
    <div className="h-[350px] w-full">
      <h4 className="text-slate-600 font-semibold mb-4">Dự báo lượng mưa 24h tới</h4>
      <ResponsiveContainer width="100%" height="100%">
        <LineChart data={forecastData}>
          ...
          <Tooltip />
          <Legend />
          <Line yAxisId="left" type="monotone" dataKey="rain" stroke="#3b82f6" activeDot={{ r: 8 }} name="Lượng mưa (mm)" />
          <Line yAxisId="right" type="monotone" dataKey="prob" stroke="#82ca9d" name="Xác suất mưa (%)" />
        </LineChart>
      </ResponsiveContainer>
    </div>
  </div>
...
const HistoryView = () => (
  <div className="space-y-4">
    <div className="h-[350px] w-full">
      <h4 className="text-slate-600 font-semibold mb-4">Tổng lượng mưa 7 ngày qua</h4>
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={historyData}>
          ...
          <Tooltip />
          <Legend />
          <Bar dataKey="mm" fill="#3b82f6" radius={[4, 4, 0, 0]} name="Lượng mưa (mm)" />
        </BarChart>
      </ResponsiveContainer>
    </div>
  </div>
